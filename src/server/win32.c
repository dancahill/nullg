...
//	hThread=(HANDLE)_beginthread(func, attr->dwStackSize?attr->dwStackSize:PTHREAD_STACK_SIZE, param);
//	hThread=(HANDLE)_beginthreadex(0, PTHREAD_STACK_SIZE, func, param, CREATE_SUSPENDED, &id);
