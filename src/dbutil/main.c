...
void usage(char *arg0)
{
	...
	printf("(as defined in groupware.cfg).  The parameter for this function\r\n");
...
int main(int argc, char *argv[])
{
	...
	if (strcmp(function, "dump2")==0) {
		return dump_db_v2(parameter, DUMP_NGW2);
	}
	if (strcmp(function, "dumpl")==0) {
		return dump_db_v2(parameter, DUMP_LDIF);
	}
