...
OUTDIR=..\..\..\..\obj\modules\ghttpd\mod_calls
INTDIR=..\..\..\..\obj\modules\ghttpd\mod_calls

ALL : "..\..\..\..\distrib\lib\ghttpd\mod_calls.dll"
...
CLEAN :
	...
	-@erase "..\..\..\..\distrib\lib\ghttpd\mod_calls.dll"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\mod_calls.pdb" /machine:I386 /def:".\mod_calls.def" /out:"..\..\..\..\distrib\lib\ghttpd\mod_calls.dll" /implib:"$(OUTDIR)\mod_calls.lib" 
DEF_FILE= \
	".\mod_calls.def"
LINK32_OBJS= \
...
"..\..\..\..\distrib\lib\ghttpd\mod_calls.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
"$(INTDIR)\mod_calls_main.obj" : $(SOURCE) "$(INTDIR)"
