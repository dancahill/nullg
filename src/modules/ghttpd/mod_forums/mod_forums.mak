...
OUTDIR=..\..\..\..\obj\modules\ghttpd\mod_forums
INTDIR=..\..\..\..\obj\modules\ghttpd\mod_forums

ALL : "..\..\..\..\distrib\lib\ghttpd\mod_forums.dll"
...
CLEAN :
	...
	-@erase "..\..\..\..\distrib\lib\ghttpd\mod_forums.dll"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\mod_forums.pdb" /machine:I386 /def:".\mod_forums.def" /out:"..\..\..\..\distrib\lib\ghttpd\mod_forums.dll" /implib:"$(OUTDIR)\mod_forums.lib" 
DEF_FILE= \
	".\mod_forums.def"
LINK32_OBJS= \
...
"..\..\..\..\distrib\lib\ghttpd\mod_forums.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
