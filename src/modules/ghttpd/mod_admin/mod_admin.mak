...
OUTDIR=..\..\..\..\obj\modules\ghttpd\mod_admin
INTDIR=..\..\..\..\obj\modules\ghttpd\mod_admin

ALL : "..\..\..\..\distrib\lib\ghttpd\mod_admin.dll"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\mod_admin.pdb" /machine:I386 /def:".\mod_admin.def" /out:"..\..\..\..\distrib\lib\ghttpd\mod_admin.dll" /implib:"$(OUTDIR)\mod_admin.lib" 
DEF_FILE= \
	".\mod_admin.def"
LINK32_OBJS= \
	...
	"$(INTDIR)\mod_admin_time.obj" \
	"$(INTDIR)\mod_admin_users.obj" \
	"$(INTDIR)\mod_admin_zones.obj"

"..\..\..\..\distrib\lib\ghttpd\mod_admin.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
SOURCE=.\mod_admin_time.c

"$(INTDIR)\mod_admin_time.obj" : $(SOURCE) "$(INTDIR)"
