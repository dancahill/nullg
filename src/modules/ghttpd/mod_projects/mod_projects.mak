...
OUTDIR=..\..\..\..\obj\modules\ghttpd\mod_projects
INTDIR=..\..\..\..\obj\modules\ghttpd\mod_projects

ALL : "..\..\..\..\distrib\lib\ghttpd\mod_projects.dll"
...
CLEAN :
	...
	-@erase "..\..\..\..\distrib\lib\ghttpd\mod_projects.dll"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\mod_projects.pdb" /machine:I386 /def:".\mod_projects.def" /out:"..\..\..\..\distrib\lib\ghttpd\mod_projects.dll" /implib:"$(OUTDIR)\mod_projects.lib" 
DEF_FILE= \
	".\mod_projects.def"
LINK32_OBJS= \
...
"..\..\..\..\distrib\lib\ghttpd\mod_projects.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
