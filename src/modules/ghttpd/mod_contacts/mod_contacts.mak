...
OUTDIR=..\..\..\..\obj\modules\ghttpd\mod_contacts
INTDIR=..\..\..\..\obj\modules\ghttpd\mod_contacts

ALL : "..\..\..\..\distrib\lib\ghttpd\mod_contacts.dll"
...
CLEAN :
	...
	-@erase "..\..\..\..\distrib\lib\ghttpd\mod_contacts.dll"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\mod_contacts.pdb" /machine:I386 /def:".\mod_contacts.def" /out:"..\..\..\..\distrib\lib\ghttpd\mod_contacts.dll" /implib:"$(OUTDIR)\mod_contacts.lib" 
DEF_FILE= \
	".\mod_contacts.def"
LINK32_OBJS= \
...
"..\..\..\..\distrib\lib\ghttpd\mod_contacts.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
"$(INTDIR)\mod_contacts_vcard.obj" : $(SOURCE) "$(INTDIR)"
