...
OUTDIR=..\..\..\..\obj\modules\ghttpd\mod_files
INTDIR=..\..\..\..\obj\modules\ghttpd\mod_files

ALL : "..\..\..\..\distrib\lib\ghttpd\mod_files.dll"


CLEAN :
	-@erase "$(INTDIR)\mod_files_conf.obj"
	-@erase "$(INTDIR)\mod_files_db.obj"
	-@erase "$(INTDIR)\mod_files_dir.obj"
	-@erase "$(INTDIR)\mod_files_file.obj"
	-@erase "$(INTDIR)\mod_files_lang.obj"
	-@erase "$(INTDIR)\mod_files_main.obj"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(OUTDIR)\mod_files.exp"
	-@erase "$(OUTDIR)\mod_files.lib"
	-@erase "..\..\..\..\distrib\lib\ghttpd\mod_files.dll"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\mod_files.pdb" /machine:I386 /def:".\mod_files.def" /out:"..\..\..\..\distrib\lib\ghttpd\mod_files.dll" /implib:"$(OUTDIR)\mod_files.lib" 
DEF_FILE= \
	".\mod_files.def"
LINK32_OBJS= \
	"$(INTDIR)\mod_files_conf.obj" \
	"$(INTDIR)\mod_files_db.obj" \
	"$(INTDIR)\mod_files_dir.obj" \
	"$(INTDIR)\mod_files_file.obj" \
	"$(INTDIR)\mod_files_lang.obj" \
	"$(INTDIR)\mod_files_main.obj"

"..\..\..\..\distrib\lib\ghttpd\mod_files.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
SOURCE=.\mod_files_dir.c

"$(INTDIR)\mod_files_dir.obj" : $(SOURCE) "$(INTDIR)"


SOURCE=.\mod_files_file.c

"$(INTDIR)\mod_files_file.obj" : $(SOURCE) "$(INTDIR)"
