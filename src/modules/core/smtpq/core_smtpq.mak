...
OUTDIR=..\..\..\..\obj\modules\core\smtpq
INTDIR=..\..\..\..\obj\modules\core\smtpq
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\core_smtpq.pdb" /machine:I386 /out:"..\..\..\..\distrib\lib\core\smtpq.dll" /implib:"$(OUTDIR)\core_smtpq.lib" 
LINK32_OBJS= \
