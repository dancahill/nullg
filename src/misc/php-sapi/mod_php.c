...
sapi_module_struct mod_php_module = {
	"embed",			/* name */
	"NullLogic GroupServer mod_php",/* pretty name */
...
#ifdef ZTS
	tsrm_startup(htproc->config.http_maxconn, 1, 0, NULL);
#endif
#ifdef ZTS
...
DllExport int mod_init(_PROC *_proc, htproc *_htproc, FUNCTION *_functions)
{
	MODULE_MENU newmod = {
		"mod_php",		/* mod_name     */
		0,			/* mod_submenu  */
