  ...
  if (bt.ns4) {                 //draw OutlookBar for ns4
    ...
    for (i=0;i<this.panels.length;i++) {
      document.write('<Layer name='+this.name+'_panel'+i+' width='+this.width);
       ...
       document.write('width=16 height=16 src=/groupware/images/arrowup.png border=0>');
       ...
       document.write('src=/groupware/images/arrowdown.png border=0></A></LAYER>');
...
//      document.write('; background-color:'+this.bgcolor+';">')
      ...
      document.write('onmouseOver="'+this.panels[i].v+'.clear();">');
      document.write('<img width=16 height=16 src=/groupware/images/arrowup.png border=0>');
      ...
      document.write('onmouseOver="'+this.panels[i].v+'.clear();">');
      document.write('<img width=16 height=16 src=/groupware/images/arrowdown.png border=0>');
      document.write('</A></DIV>');
