...
OUTDIR=.\..\..\..\obj\httpd_modules\mod_searches
INTDIR=.\..\..\..\obj\httpd_modules\mod_searches

ALL : "..\..\..\distrib\lib\httpd\mod_searches.dll"
...
CLEAN :
	...
	-@erase "..\..\..\distrib\lib\httpd\mod_searches.dll"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_searches.pdb" /machine:I386 /def:".\mod_searches.def" /out:"..\..\..\distrib\lib\httpd\mod_searches.dll" /implib:"$(OUTDIR)\mod_searches.lib" 
DEF_FILE= \
	".\mod_searches.def"
LINK32_OBJS= \
...
"..\..\..\distrib\lib\httpd\mod_searches.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
