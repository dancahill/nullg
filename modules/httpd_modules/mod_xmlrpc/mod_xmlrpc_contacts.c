...
void xmlrpc_contact_addstruct(CONN *sid, int sqr, int tuple)
{
	...
	xmlrpc_addmember(sid, "loginip",        "string",   "%s", sql_getvalue(sqr, tuple, 9));
	xmlrpc_addmember(sid, "logintime",      "dateTime", "%d", time_sql2unix(sql_getvalue(sqr, tuple, 10)));
	xmlrpc_addmember(sid, "logintoken",     "string",   "%s", sql_getvalue(sqr, tuple, 11));
	xmlrpc_addmember(sid, "username",       "string",   "%s", sql_getvalue(sqr, tuple, 12));
	xmlrpc_addmember(sid, "password",       "string",   "%s", sql_getvalue(sqr, tuple, 13));
	xmlrpc_addmember(sid, "enabled",        "int",      "%d", atoi(sql_getvalue(sqr, tuple, 14)));
	xmlrpc_addmember(sid, "geozone",        "int",      "%d", atoi(sql_getvalue(sqr, tuple, 15)));
	xmlrpc_addmember(sid, "timezone",       "int",      "%d", atoi(sql_getvalue(sqr, tuple, 16)));
	xmlrpc_addmember(sid, "surname",        "string",   "%s", sql_getvalue(sqr, tuple, 17));
	xmlrpc_addmember(sid, "givenname",      "string",   "%s", sql_getvalue(sqr, tuple, 18));
	xmlrpc_addmember(sid, "salutation",     "string",   "%s", sql_getvalue(sqr, tuple, 19));
	xmlrpc_addmember(sid, "contacttype",    "string",   "%s", sql_getvalue(sqr, tuple, 20));
	xmlrpc_addmember(sid, "referredby",     "string",   "%s", sql_getvalue(sqr, tuple, 21));
	xmlrpc_addmember(sid, "altcontact",     "string",   "%s", sql_getvalue(sqr, tuple, 22));
	xmlrpc_addmember(sid, "prefbilling",    "string",   "%s", sql_getvalue(sqr, tuple, 23));
	xmlrpc_addmember(sid, "website",        "string",   "%s", sql_getvalue(sqr, tuple, 24));
	xmlrpc_addmember(sid, "email",          "string",   "%s", sql_getvalue(sqr, tuple, 25));
	xmlrpc_addmember(sid, "homenumber",     "string",   "%s", sql_getvalue(sqr, tuple, 26));
	xmlrpc_addmember(sid, "worknumber",     "string",   "%s", sql_getvalue(sqr, tuple, 27));
	xmlrpc_addmember(sid, "faxnumber",      "string",   "%s", sql_getvalue(sqr, tuple, 28));
	xmlrpc_addmember(sid, "mobilenumber",   "string",   "%s", sql_getvalue(sqr, tuple, 29));
	xmlrpc_addmember(sid, "jobtitle",       "string",   "%s", sql_getvalue(sqr, tuple, 30));
	xmlrpc_addmember(sid, "organization",   "string",   "%s", sql_getvalue(sqr, tuple, 31));
	xmlrpc_addmember(sid, "homeaddress",    "string",   "%s", sql_getvalue(sqr, tuple, 32));
	xmlrpc_addmember(sid, "homelocality",   "string",   "%s", sql_getvalue(sqr, tuple, 33));
	xmlrpc_addmember(sid, "homeregion",     "string",   "%s", sql_getvalue(sqr, tuple, 34));
	xmlrpc_addmember(sid, "homecountry",    "string",   "%s", sql_getvalue(sqr, tuple, 35));
	xmlrpc_addmember(sid, "homepostalcode", "string",   "%s", sql_getvalue(sqr, tuple, 36));
	xmlrpc_addmember(sid, "workaddress",    "string",   "%s", sql_getvalue(sqr, tuple, 37));
	xmlrpc_addmember(sid, "worklocality",   "string",   "%s", sql_getvalue(sqr, tuple, 38));
	xmlrpc_addmember(sid, "workregion",     "string",   "%s", sql_getvalue(sqr, tuple, 39));
	xmlrpc_addmember(sid, "workcountry",    "string",   "%s", sql_getvalue(sqr, tuple, 40));
	xmlrpc_addmember(sid, "workpostalcode", "string",   "%s", sql_getvalue(sqr, tuple, 41));
	prints(sid, "</struct>\r\n</value>\r\n");
	return;
}
