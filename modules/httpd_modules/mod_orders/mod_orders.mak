...
OUTDIR=.\..\..\..\obj\httpd_modules\mod_orders
INTDIR=.\..\..\..\obj\httpd_modules\mod_orders

ALL : "..\..\..\distrib\lib\httpd\mod_orders.dll"
...
CLEAN :
	...
	-@erase "..\..\..\distrib\lib\httpd\mod_orders.dll"
...
"..\..\..\distrib\lib\httpd\mod_orders.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
