...
OUTDIR=.\..\..\..\obj\httpd_modules\mod_contacts
INTDIR=.\..\..\..\obj\httpd_modules\mod_contacts

ALL : "..\..\..\distrib\lib\httpd\mod_contacts.dll"
...
CLEAN :
	...
	-@erase "..\..\..\distrib\lib\httpd\mod_contacts.dll"
...
"..\..\..\distrib\lib\httpd\mod_contacts.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
