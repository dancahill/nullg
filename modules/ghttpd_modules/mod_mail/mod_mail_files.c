...
int wmfolder_makedefaults(CONN *sid, int accountid)
{
	...
	sql_updatef("INSERT INTO gw_mailfolders (mailfolderid, obj_ctime, obj_mtime, obj_uid, obj_gid, obj_did, obj_gperm, obj_operm, accountid, parentfolderid, foldername) values ('1', '%s', '%s', '%d', '0', '%d', '0', '0', '%d', '0', '%s');", curdate, curdate, sid->dat->user_uid, sid->dat->user_did, accountid, lang.folder1_name);
	sql_updatef("INSERT INTO gw_mailfolders (mailfolderid, obj_ctime, obj_mtime, obj_uid, obj_gid, obj_did, obj_gperm, obj_operm, accountid, parentfolderid, foldername) values ('2', '%s', '%s', '%d', '0', '%d', '0', '0', '%d', '0', '%s');", curdate, curdate, sid->dat->user_uid, sid->dat->user_did, accountid, lang.folder2_name);
	sql_updatef("INSERT INTO gw_mailfolders (mailfolderid, obj_ctime, obj_mtime, obj_uid, obj_gid, obj_did, obj_gperm, obj_operm, accountid, parentfolderid, foldername) values ('3', '%s', '%s', '%d', '0', '%d', '0', '0', '%d', '0', '%s');", curdate, curdate, sid->dat->user_uid, sid->dat->user_did, accountid, lang.folder3_name);
	sql_updatef("INSERT INTO gw_mailfolders (mailfolderid, obj_ctime, obj_mtime, obj_uid, obj_gid, obj_did, obj_gperm, obj_operm, accountid, parentfolderid, foldername) values ('4', '%s', '%s', '%d', '0', '%d', '0', '0', '%d', '0', '%s');", curdate, curdate, sid->dat->user_uid, sid->dat->user_did, accountid, lang.folder4_name);
	sql_updatef("INSERT INTO gw_mailfolders (mailfolderid, obj_ctime, obj_mtime, obj_uid, obj_gid, obj_did, obj_gperm, obj_operm, accountid, parentfolderid, foldername) values ('5', '%s', '%s', '%d', '0', '%d', '0', '0', '%d', '0', '%s');", curdate, curdate, sid->dat->user_uid, sid->dat->user_did, accountid, lang.folder5_name);
	sql_updatef("INSERT INTO gw_mailfolders (mailfolderid, obj_ctime, obj_mtime, obj_uid, obj_gid, obj_did, obj_gperm, obj_operm, accountid, parentfolderid, foldername) values ('6', '%s', '%s', '%d', '0', '%d', '0', '0', '%d', '0', '%s');", curdate, curdate, sid->dat->user_uid, sid->dat->user_did, accountid, lang.folder6_name);
	sql_updatef("INSERT INTO gw_mailfolders (mailfolderid, obj_ctime, obj_mtime, obj_uid, obj_gid, obj_did, obj_gperm, obj_operm, accountid, parentfolderid, foldername) values ('7', '%s', '%s', '%d', '0', '%d', '0', '0', '%d', '0', '%s');", curdate, curdate, sid->dat->user_uid, sid->dat->user_did, accountid, lang.folder7_name);
	return 0;
}
...
stuff:
	...
	sql_updatef("UPDATE gw_mailheaders SET size = '%d' WHERE mailheaderid = %d AND accountid = %d", (int)sb.st_size, headerid, sid->dat->user_mailcurrent);
	prints(sid, "OK<BR>\r\n");
