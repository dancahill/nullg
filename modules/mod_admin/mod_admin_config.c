...
void adminconfigedit(CONN *sid)
{
	...
	prints(sid, "<TR CLASS=\"EDITFORM\"><TD NOWRAP>&nbsp;<B>%s</B>&nbsp;</TD><TD ALIGN=RIGHT><INPUT TYPE=TEXT NAME=server_dir_var_files  VALUE=\"%s\" SIZE=45 STYLE='width:255px'></TD></TR>\n", ADM_CFG_SRVFILE, str2html(sid, cfg.server_dir_var_files));
	...
	prints(sid, "<TR CLASS=\"EDITFORM\"><TD NOWRAP>&nbsp;<B>%s</B>&nbsp;</TD><TD ALIGN=RIGHT><INPUT TYPE=TEXT NAME=server_dir_var_mail   VALUE=\"%s\" SIZE=45 STYLE='width:255px'></TD></TR>\n", ADM_CFG_SRVMAIL, str2html(sid, cfg.server_dir_var_mail));
