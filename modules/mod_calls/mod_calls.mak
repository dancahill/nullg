...
!MESSAGE No configuration specified. Defaulting to mod_calls - Win32 Release.
!ENDIF 
...
!IF EXISTS("mod_calls.dep")
!INCLUDE "mod_calls.dep"
!ELSE 
!MESSAGE Warning: cannot find "mod_calls.dep"
!ENDIF 
!ENDIF 
