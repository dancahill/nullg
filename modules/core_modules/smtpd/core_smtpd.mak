...
OUTDIR=.\..\..\..\obj\core_modules\core_smtpd
INTDIR=.\..\..\..\obj\core_modules\core_smtpd
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\core_smtpd.pdb" /machine:I386 /out:"..\..\..\distrib\lib\core\smtpd.dll" /implib:"$(OUTDIR)\core_smtpd.lib" 
LINK32_OBJS= \
