...
!MESSAGE No configuration specified. Defaulting to mod_files - Win32 Release.
!ENDIF 
...
!IF EXISTS("mod_files.dep")
!INCLUDE "mod_files.dep"
!ELSE 
!MESSAGE Warning: cannot find "mod_files.dep"
!ENDIF 
!ENDIF 
