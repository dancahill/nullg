...
{
	MOD_HTML_HEADER mod_html_header;
...
{
	MOD_HTML_FOOTER mod_html_footer;
...
{
	MOD_HTML_LOGOUT mod_html_logout;
...
{
	MOD_HTML_FRAMESET mod_html_frameset;
...
{
	MOD_HTML_TOPMENU mod_html_topmenu;
	char *ptemp;
	int dot=0;
	int folderid=0;
	int userid=-1;
