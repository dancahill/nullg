# Microsoft Developer Studio Generated NMAKE File, Based on smtpd.dsp
!IF "$(CFG)" == ""
CFG=smtpd - Win32 Release
!MESSAGE smtpd - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "smtpd - Win32 Release"
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\smtpd.bsc" 
BSC32_SBRS= \
...
"$(OUTDIR)\nullgw-smtpd.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
