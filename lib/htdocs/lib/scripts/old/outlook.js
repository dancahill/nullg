...
var c=0;
  ...
  if (bt.ns4) {                 //draw OutlookBar for ns4
    //OutlookBar layer..
    document.write('<layer background=/nullsd/themes/default/bg_menu.png bgcolor='+this.bgcolor+' name='+this.name+' left=');
    ...
    for (i=0;i<this.panels.length;i++) {
      document.write('<Layer name='+this.name+'_panel'+i+' width='+this.width);
       document.write(' top='+i*22+' background=/nullsd/themes/default/bg_main.png bgcolor='+this.bgcolor);
       ...
       document.write('width=16 height=16 src=/nullsd/images/arrowup.png border=0>');
       ...
       document.write('src=/nullsd/images/arrowdown.png border=0></A></LAYER>');
    ...
    for (i=0;i<this.panels.length;i++) {
      ...
      document.write(this.bgcolor+'; background-image:url(/nullsd/themes/default/bg_menu.png);">')
      t=t+22;
...
//      document.write('; background-color:'+this.bgcolor+';">')
      ...
      document.write('onmouseOver="'+this.panels[i].v+'.clear();">');
      document.write('<img width=16 height=16 src=/nullsd/images/arrowup.png border=0>');
      ...
      document.write('onmouseOver="'+this.panels[i].v+'.clear();">');
      document.write('<img width=16 height=16 src=/nullsd/images/arrowdown.png border=0>');
      document.write('</A></DIV>');
