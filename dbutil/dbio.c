...
int dump_db(char *filename)
{
	...
	if (dump_table(fp, "gw_domainaliases",		"domainaliasid")<0)	printf("\r\nError dumping gw_domainaliases\r\n");
	...
	if (dump_table(fp, "gw_groupmembers",		"groupmemberid")<0) 	printf("\r\nError dumping gw_groupmembers\r\n");
...
int init_mdb(void)
{
	...
	if (sqlUpdate(1, MDB_DOMAINALIASES)<0)     { printf("\r\nError inserting gw_domainaliasess\r\n");  return -1; }
	...
	if (sqlUpdate(1, MDB_GROUPMEMBERS)<0)      { printf("\r\nError inserting gw_groupmembers\r\n");    return -1; }
...
int init_mysql(void)
{
	...
	sqlUpdate(0, "DROP TABLE IF EXISTS gw_domainaliases;");
	...
	sqlUpdate(0, "DROP TABLE IF EXISTS gw_groupmembers;");
	...
	if (sqlUpdate(1, MYSQLDB_DOMAINALIASES)<0)         { printf("\r\nError inserting gw_domainaliases\r\n");   return -1; }
	...
	if (sqlUpdate(1, MYSQLDB_GROUPMEMBERS)<0)          { printf("\r\nError inserting gw_groupmembers\r\n");    return -1; }
...
int init_pgsql(void)
{
	...
	sqlUpdate(0, "DROP SEQUENCE domlid_seq;");
	...
	sqlUpdate(0, "DROP SEQUENCE grpmid_seq;");
	...
	sqlUpdate(0, "DROP SEQUENCE smtrid_seq;");
	...
	sqlUpdate(0, "DROP TABLE gw_domainaliases;");
	...
	sqlUpdate(0, "DROP TABLE gw_groupmembers;");
	...
	if (sqlUpdate(1, PGSQLDB_DOMAINALIASES)<0)   { printf("\r\nError inserting gw_domainaliases\r\n");   return -1; }
	...
	if (sqlUpdate(1, PGSQLDB_GROUPMEMBERS)<0)    { printf("\r\nError inserting gw_groupmembers\r\n");    return -1; }
...
int init_pgsqlseq(void)
{
	...
	pgsql_seqsync("gw_domainaliases",   "domainaliasid",  "domlid_seq");
	...
	pgsql_seqsync("gw_groupmembers",    "groupmemberid",  "grpmid_seq");
...
int init_sqlite(void)
{
	...
	if (sqlUpdate(1, SQLITEDB_DOMAINALIASES)<0)   { printf("\r\nError inserting gw_domainaliases\r\n");   return -1; }
	...
	if (sqlUpdate(1, SQLITEDB_GROUPMEMBERS)<0)    { printf("\r\nError inserting gw_groupmembers\r\n");    return -1; }
