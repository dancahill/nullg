...
#define NSD_NOFUNCTIONS 1
#include "nsd.h"
#undef NSD_NOFUNCTIONS
#include "nullsd/typedefs.h"
#include "nullsd/httpd_errno.h"
...
typedef obj_t     *(*MAIN_LDIR_GETLIST)(nsp_state *, char *, int, int);
typedef obj_t     *(*MAIN_LDIR_GETENTRY)(nsp_state *, char *, char *, int, int);
...
typedef int        (*MAIN_HTNSP_DOTEMPLATE)(CONN *, char *, char *);
...
EXTERN MAIN_HTNSP_DOTEMPLATE		htnsp_dotemplate;
...
//	if (_get_func((void *)&htscript_showpage,		"htscript_showpage"		)!=0) return -1;
	...
	if (_get_func((void *)&htnsp_dotemplate,		"htnsp_dotemplate"		)!=0) return -1;
