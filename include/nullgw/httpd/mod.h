...
#include <ctype.h>
#include <pthread.h>	/* openbsd wants this */
#include <stdarg.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
#include "nullgw/httpd/errno.h"
#include "nullgw/httpd/typedefs.h"
...
typedef	int   (*MAIN_SQL_PERMPRUNE)(CONN *, SQLRES *, char *);
...
int mod_export_main(MODULE_MENU *newmod)
{
	...
	for (i=0;i<50;i++) {
		...
		snprintf(http_proc->mod_menuitems[i].mod_menupic, sizeof(http_proc->mod_menuitems[i].mod_menupic)-1, "%s", newmod->mod_menupic);
