...
static const tabledef mysqldb_tables[] = {
	...
	},
	{
		...
		"	bookmarkname	varchar(100)	NOT NULL DEFAULT '',\n"
	...
	},
	{
		...
		"	actionid	int4		NOT NULL auto_increment,\n"
		"	obj_ctime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_mtime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_uid		int4		NOT NULL DEFAULT 0,\n"
		"	obj_gid		int4		NOT NULL DEFAULT 0,\n"
	...
	},
	{
		...
		"	sessionid	int4		NOT NULL auto_increment,\n"
		"	obj_ctime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_mtime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_uid		int4		NOT NULL DEFAULT 0,\n"
		"	obj_gid		int4		NOT NULL DEFAULT 0,\n"
	...
	},
	{
		...
		"	accountid	int4		NOT NULL auto_increment,\n"
		"	obj_ctime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_mtime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_uid		int4		NOT NULL DEFAULT 0,\n"
		"	obj_gid		int4		NOT NULL DEFAULT 0,\n"
	...
	},
	{
		...
		"	inventoryid	int4		NOT NULL auto_increment,\n"
		"	obj_ctime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_mtime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_uid		int4		NOT NULL DEFAULT 0,\n"
		"	obj_gid		int4		NOT NULL DEFAULT 0,\n"
	...
	},
	{
		...
		"	invoiceid	int4		NOT NULL auto_increment,\n"
		"	obj_ctime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_mtime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_uid		int4		NOT NULL DEFAULT 0,\n"
		"	obj_gid		int4		NOT NULL DEFAULT 0,\n"
		...
		"	contactid	int4		NOT NULL DEFAULT 0,\n"
		"	userid		int4		NOT NULL DEFAULT 0,\n"
		"	invoicedate	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
	...
	},
	{
		...
		"	invoiceitemid	int4		NOT NULL auto_increment,\n"
		"	obj_ctime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_mtime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_uid		int4		NOT NULL DEFAULT 0,\n"
		"	obj_gid		int4		NOT NULL DEFAULT 0,\n"
	...
	},
	{
		...
		"	entryid		int4		NOT NULL auto_increment,\n"
		"	obj_ctime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_mtime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_uid		int4		NOT NULL DEFAULT 0,\n"
		"	obj_gid		int4		NOT NULL DEFAULT 0,\n"
	...
	},
	{
		...
		"	groupmemberid	int4		NOT NULL auto_increment,\n"
		"	obj_ctime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_mtime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_uid		int4		NOT NULL DEFAULT 0,\n"
		"	obj_gid		int4		NOT NULL DEFAULT 0,\n"
	...
	},
	{
		...
		"	commentid	int4		NOT NULL auto_increment,\n"
		"	obj_ctime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_mtime	datetime	NOT NULL DEFAULT '1970-01-01 00:00:00',\n"
		"	obj_uid		int4		NOT NULL DEFAULT 0,\n"
		"	obj_gid		int4		NOT NULL DEFAULT 0,\n"
	...
	},
	{
		...
		"	obj_gperm	int4		NOT NULL DEFAULT 0,\n"
		"	obj_operm	int4		NOT NULL DEFAULT 0,\n"
		"	entrygroupid	int4		NOT NULL DEFAULT 0,\n"
		"	subject		varchar(120)	NOT NULL DEFAULT '',\n"
