...
#define GHTTP_PORT		4110
#define GHTTPS_PORT		4112
#define HTTP_PORT		80
...
#else
//	#define DEBUG_IN(SID, a) log_error("debug", __FILE__, __LINE__, 0, "Entering %s.", a)
//	#define DEBUG_OUT(SID, a) log_error("debug", __FILE__, __LINE__, 0, "Exiting  %s.", a)
