...
char *sql_getvaluebyname(nsp_state *N, obj_t **qptr, int tuple, char *fieldname);
int   sql_numfields(nsp_state *N, obj_t **qptr);
int   sql_numtuples(nsp_state *N, obj_t **qptr);
