...
#define SERVER_BASENAME	"nullgs"
#define SERVICE_NAME	"nullgs"
...
#define logruntime() { \
	...
	totaltime=(float)(((ttime.tv_sec-sid->dat->runtime.tv_sec)*1000000)+(ttime.tv_usec-sid->dat->runtime.tv_usec))/1000000; \
	snprintf(namebuf, 127, "_debug:%.6f", totaltime); \
	snprintf(linebuf, 127, "%s:%d", __FILE__, __LINE__); \
	nes_setstr(sid->N, &sid->N->g, namebuf, linebuf, strlen(linebuf)); \
}
